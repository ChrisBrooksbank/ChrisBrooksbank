...
I like clear code, useful documentation, small feedback loops, and tools that make the next step easier for the person using them. My repos are a mix of production-adjacent systems, learning notes, and experiments, because I find the best way to understand something is usually to build a small version of it.
